...
<html lang="en">
  ...
  -->
    <link
      rel="shortcut icon"
      href="{{ asset('frontend/assets/images/logo/favicon.ico') }}"
      type="image/x-icon"
    />
                ...
                <div class="col-lg-6">
                  <div class="shadow p-3 mb-3 bg-body rounded">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3 showcase_content">
                        <a href="#">
                          <h4 class="showcase_title">
                            Rose Gold Peacock Earrings
                          </h4>
                        </a>

                        <a href="#" class="showcase_category">jewellery</a>

                        <div class="all_price_box">
                          <p class="all_price">$20.00</p>
                          <del>$30.00</del>
                        </div>
                      </div>
                    </div>
