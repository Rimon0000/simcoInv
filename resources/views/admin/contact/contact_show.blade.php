                ...
                <table class="table table-striped" id="categoryTable" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route ('contact.status', ['id' => $datum -> id]) }}" class="btn btn-sm {{ $datum->status == 1 ? 'btn-info': 'btn-danger' }}"> {{ $datum->status == 1 ? 'Responsed': 'Unresponse' }}</a></td>
                            <td>
                            <a href="{{ route('contact.delete', ['id' => $datum->id]) }}" onclick="return confirm('Are You Sure?')" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
