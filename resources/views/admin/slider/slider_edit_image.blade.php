    ...
    <div class="col-lg-8">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('slider.image.update', ['id'=> $data->id])}}" enctype="multipart/form-data">
                    @csrf

                    <h6 class="pb-3">Previous Image:</h6>
                    <div class="row">
                        <div class="col-lg-12">
                        <img src="{{ empty($data->slider_img) ? asset('backend/assets/img/default-img.png') : asset($data->slider_img) }}" class="img-thumbnail" alt="..." width="200px" height="200px">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="validationServer01">Slider Alt</label>
                            <input type="text" class="form-control" value="{{ $data->slider_alt }}" name="slider_alt" id="validationServer01" placeholder="Slider Alt">
                            <div class="pt-1">
                                @error('slider_alt')
                                <span class="text-danger"> {{$message}} </span>
                                @enderror
