                                        ...
                                        <table style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td__height">{{ $datum->customerName->customer_name }}</td>
                                                    <td class="td__height">{{ $datum->invoice_no }}</td>
                                                    <td class="td__height">{{ date('d-M-y', strtotime($datum->invoice_date)) }}</td>
                                                    <td class="td__height">{{ $datum->due_amount }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; font-size: 18px;">{{ $total_due }}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
