                                        ...
                                        <table style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td__height">{{ $datum->title }}</td>
                                                    <td class="td__height">{{ $datum->stock }}</td>
                                                    <td class="td__height">{{ $datum->unitName->unit_name }}</td>
                                                    <td class="td__height">{{ $datum->price }}</td>
                                                    <td class="td__height">{{ $datum->sale_price }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
