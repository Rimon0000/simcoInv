<div class="blog">
    <div class="my_container">
        <div class="blog-container has-scrollbar">
            ...
            <div class="blog-card">
                <a href="#">
                    <img src="{{ asset('frontend/assets/images/blog-2.jpg') }}" alt="Curbside fashion Trends: How to Win the Pickup Battle." class="blog-banner" width="300" />
                </a>
            ...
            <div class="blog-card">
                <a href="#">
                    <img src="{{ asset('frontend/assets/images/blog-3.jpg') }}" alt="EBT vendors: Claim Your Share of SNAP Online Revenue." class="blog-banner" width="300" />
                </a>
            ...
            <div class="blog-card">
                <a href="#">
                    <img src="{{ asset('frontend/assets/images/blog-4.jpg') }}" alt="Curbside fashion Trends: How to Win the Pickup Battle." class="blog-banner" width="300" />
                </a>
